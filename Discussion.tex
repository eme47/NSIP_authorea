...
BSC N-fixation has long been attributed to heterocystous \textit{Cyanobacteria} and
...
non-heterocystous \textit{Cyanobacteria} \citep{Gaby_2012}. Unfortunately, it is impossible to
...
trichome of filamentous heterocystous \textit{Cyanobacteria} such as \textit{Nostoc} and
...
We did not observe evidence for N-fixation by heterocystous \textit{Cyanobacteria} in
...
study possessed less heterocystous \textit{Cyanobacteria} than dark mature BSC, as has
...
sequence libraries were from heterocystous \textit{Cyanobacteria} (see results) as
...
defined by selected heterocystous \textit{Cyanobacteria} sequences presented in
...
heterocystous \textit{Cyanobacteria} sequences in the DNA-SIP data set, it is not
possible to assess whether heterocystous \textit{Cyanobacteria} incorporated $^{15}$N during
the incubation.
...
a paucity of heterocystous \textit{Cyanobacteria} from the beginning (see above). It
should be noted that "light" and in particular "sub-biocrust" samples possess
much less heterocystous \textit{Cyanobacteria} in general (Figure~\ref{fig:het_steven})
...
Therefore, the relative abundance of heterocystous \textit{Cyanobacteria} \textit{nifH}
...
further exacerbate this bias, as many \textit{Cyanobacteria} are estimated to have
...
\subsection{Temperature influences on heterocystozus \textit{Cyanobacteria} relative abundance} 
...
\textit{Cyanobacteria} are not key contributors to the BSC N-budget. But, the putative
...
that heterocystous \textit{Cyanobacteria} increase in abundance with BSC age

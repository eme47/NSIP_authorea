...
After 2 and 4 incubation days in the presence or absence of $^{15}$N$_{2}$
...
%SIP places focus upon organisms based on isotope
%incorporation and has the ability to detect activity by low abundance members
%of the community.  DNA from OTUs that incopororate $^{15}$N into their biomass
%moves towards the heavy end of the CsCl gradient and therefore OTUs in
...
along a trichome and even the non-heterocyst (and non-N-fixing) cells in the
...
\textit{Clostridiaceae} are likely BSC ecosystem pioneers. \textit{M. vaginatus}
accumulates compatible solutes such as trehalose and sucrose as osmoprotectants

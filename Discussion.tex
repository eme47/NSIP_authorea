...
\textit{Proteobacteria} sequence annotations. The increased \textit{Firmicutes}
and \textit{Proteobacteria} annotations are consistent with the phylum-level
...
biomass moves towards the heavy end of the CsCl gradient and are therefore is
generally enriched in the full data pool relative to environmental DNA. 

...
to be correlated with fraction density (Adonis test p-value for density with
...
or \textit{Proteobacteria} (4 OTUs). Table X summarizes the results from BLAST
...
responders all share high identity ($>$98.48\% identity, Table X) with
